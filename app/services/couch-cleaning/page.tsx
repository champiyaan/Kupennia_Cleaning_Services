...
export const metadata: Metadata = generateServiceMetadata('couch-cleaning');

export default function CouchCleaningPage() {
  const serviceData = getServiceData('couch-cleaning');
