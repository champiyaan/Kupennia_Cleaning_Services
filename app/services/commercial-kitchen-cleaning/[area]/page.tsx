...
export async function generateMetadata({ 
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: 'website',
      url: `https://kupennia.co.zw/services/commercial-kitchen-cleaning/${area}`,
    },
  };
}
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://kupennia.co.zw/services/commercial-kitchen-cleaning"
              },
              {
                "@type": "ListItem",
                "position": 4,
                "name": `${serviceData.title} ${areaName}`,
                "item": `https://kupennia.co.zw/services/commercial-kitchen-cleaning/${area}`
              }
            ]
          })
        }}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mb-8 text-sm text-gray-600">
            <ol className="flex flex-wrap items-center space-x-2">
              ...
              <li>/</li>
              <li><Link href="/services/commercial-kitchen-cleaning" className="hover:text-primary-600">{serviceData.title}</Link></li>
              <li>/</li>
              ...
              <div className="bg-gray-50 rounded-lg p-8 md:p-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {areaData.nearbyAreas.map((nearbyArea, index) => (
                    <Link
                      key={index}
                      href={`/services/commercial-kitchen-cleaning/${nearbyArea.href.split('/').pop()}`}
