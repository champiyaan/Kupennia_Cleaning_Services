...
export async function generateMetadata({ 
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: 'website',
      url: `https://kupennia.com/services/pavement-cleaning/${area}`,
    },
  };
}
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://kupennia.com/services/pavement-cleaning"
              },
              {
                "@type": "ListItem",
                "position": 4,
                "name": `${serviceData.title} ${areaName}`,
                "item": `https://kupennia.com/services/pavement-cleaning/${area}`
              }
            ]
          })
        }}
