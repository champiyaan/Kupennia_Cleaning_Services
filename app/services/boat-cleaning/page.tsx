...
export const metadata: Metadata = generateServiceMetadata('boat-cleaning');

export default function BoatCleaningPage() {
  const serviceData = getServiceData('boat-cleaning');
