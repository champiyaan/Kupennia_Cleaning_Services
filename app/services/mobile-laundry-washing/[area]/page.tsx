...
export async function generateMetadata({ 
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: 'website',
      url: `https://kupennia.com/services/mobile-laundry-washing/${area}`,
    },
  };
}
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://kupennia.com/services/mobile-laundry-washing"
              },
              {
                "@type": "ListItem",
                "position": 4,
                "name": `${serviceData.title} ${areaName}`,
                "item": `https://kupennia.com/services/mobile-laundry-washing/${area}`
              }
            ]
          })
        }}
