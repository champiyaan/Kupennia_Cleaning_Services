...
export const metadata: Metadata = generateServiceMetadata('mobile-laundry-washing');

export default function MobileLaundryWashingPage() {
  const serviceData = getServiceData('mobile-laundry-washing');
