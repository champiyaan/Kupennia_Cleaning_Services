...
export const metadata: Metadata = {
  ...
  description: 'Kupennia Cleaning Services provides professional cleaning services throughout Harare, Zimbabwe. We serve Glen Lorne, Borrowdale, Mount Pleasant, Pomona, Helensvale, Carrick Creagh, Highlands, and all areas in Harare.',
  keywords: [
