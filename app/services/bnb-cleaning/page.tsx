...
export const metadata: Metadata = generateServiceMetadata('bnb-cleaning');

export default function BnbCleaningPage() {
  const serviceData = getServiceData('bnb-cleaning');
